...
const hasChildrenValues = (arr, character) => {
  ...
  //   let nameOfCharacter = arr[i].name;
  //   if (nameOfCharacter === character) {
  //     return arr[i].children.length === 0 ? false : true
  //   }
  // }
  // return false;
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    let nameOfCharacter = objectValues[0];
    if (nameOfCharacter === character) {
